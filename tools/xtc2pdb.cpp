    ...
    for(protein = 0; protein < proteins.size() - 1; ++protein)
    {
        ...
        while (atom <= atoms)
        {
            file << "ATOM " << std::setw(6) << atom << "  N   ALA A " << std::setw(3) << triple << "    "
                 << std::setw(8) << std::fixed <<  std::setprecision(3) << proteins[protein][atom-1][0] * 10
                 << std::setw(8) << std::fixed <<  std::setprecision(3) << proteins[protein][atom-1][1] * 10
                 << std::setw(8) << std::fixed <<  std::setprecision(3) << proteins[protein][atom-1][2] * 10 << "  1.00  0.00\n";
